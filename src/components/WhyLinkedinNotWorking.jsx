  ...
  const painPoints = [
    {
      ...
      solution: 'We build your targeted positioning before publishing a single word.',
      points: [
    ...
    },
    {
      ...
      solution: 'We capture your stories in 45 mins/month so content sounds 100% authentic.',
      points: [
    ...
    },
    {
      ...
      solution: 'We set up an outbound engine sending ~200 targeted connection requests a week.',
      points: [
    ...
    },
    {
      ...
      solution: 'You get a documented 90-day roadmap + lifetime Claude AI skill handover.',
      points: [
  ...
  return (
    <section id="why-linkedin" className="snap-section min-h-[auto] md:min-h-screen py-14 sm:py-24 bg-[#f8fafc] border-y border-slate-200 relative z-20 overflow-hidden flex flex-col justify-center">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="text-[11px] sm:text-xs font-bold uppercase tracking-widest text-[#b45309] px-3.5 py-1.5 rounded-full bg-[#f4ba43]/20 border border-[#f4ba43]/40 inline-block mb-3 shadow-xs">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3.5 sm:mb-4">
                    <motion.div
                      ...
                      className={`p-2.5 sm:p-3 rounded-xl ${item.bgLight} transition-colors shadow-xs`}
                    >
                      <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
                    </motion.div>
                    <span className="text-[10px] sm:text-[11px] font-bold px-2.5 py-1 rounded-full bg-slate-100 text-slate-700 border border-slate-200 shadow-xs">
                      {item.badge}
                    </span>
                  </div>
                  ...
                  <ul className="space-y-2.5 sm:space-y-3">
                    {item.points.map((pt, pIdx) => (
                      <li key={pIdx} className="flex items-start gap-2.5 sm:gap-3 text-xs sm:text-sm text-slate-700 font-medium leading-relaxed">
