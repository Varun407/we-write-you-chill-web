...
export default function Hero({ onOpenBooking }) {
  ...
  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-white bg-grid-pattern">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#2650a8]/8 rounded-full blur-[140px] pointer-events-none"></div>
      <div className="absolute top-1/3 right-5 w-[450px] h-[450px] bg-[#f4ba43]/15 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        >
          ...
          >
            <a
              ...
              className="btn-shimmer w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full text-sm sm:text-base font-bold text-white bg-[#2650a8] hover:bg-[#1d4088] shadow-xl shadow-[#2650a8]/25 transition-all duration-300 cursor-pointer border border-[#2650a8]/50 hover:scale-[1.02]"
            >
          ...
          >
            <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-50 border border-slate-200/80 shadow-xs hover:border-[#2650a8]/30 transition-colors">
              <CheckCircle2 className="w-4 h-4 text-[#2650a8] shrink-0" />
              <span>Only 45 Mins Needed Every 4 Weeks</span>
            </div>
            <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-50 border border-slate-200/80 shadow-xs hover:border-[#f4ba43]/40 transition-colors">
          ...
          {/* Hero Video / Strategy Assessment Container (Clean, Solid, Premium) */}
          <motion.div 
            variants={itemVariants}
            className="mt-12 relative max-w-4xl mx-auto w-full rounded-2xl p-2.5 bg-white border border-slate-200 shadow-2xl overflow-hidden group"
          >
            <div className="relative aspect-video w-full rounded-xl overflow-hidden bg-slate-950 flex items-center justify-center border border-slate-100">
              ...
              {/* Badges Top Left & Bottom Right */}
              <div className="absolute top-4 left-4 sm:top-6 sm:left-6 flex items-center gap-3 px-3.5 py-2 rounded-xl bg-white/95 backdrop-blur-md border border-slate-200 text-left shadow-lg z-20">
              ...
              <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 flex items-center gap-3 px-4 py-2 rounded-xl bg-white/95 backdrop-blur-md border border-slate-200 text-left shadow-lg z-20">
              ...
              <div className="relative z-20 flex flex-col items-center gap-3">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-16 h-16 sm:w-18 sm:h-18 rounded-full bg-[#2650a8] text-white flex items-center justify-center shadow-xl shadow-[#2650a8]/50 transition-all duration-300 hover:scale-105 hover:bg-[#1d4088] cursor-pointer border-2 border-white"
                >
