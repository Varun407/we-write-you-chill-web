    ...
    <section id="services" className="py-24 bg-white relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="p-8 pt-9 rounded-3xl bg-white border-2 border-[#2650a8] shadow-xl hover:shadow-2xl hover:border-[#1d4088] transition-all duration-300 flex flex-col justify-between relative group">
            ...
            <a
              ...
              className="btn-shimmer w-full inline-flex items-center justify-center gap-2.5 py-3.5 px-5 rounded-2xl text-xs sm:text-sm font-bold text-white bg-[#2650a8] hover:bg-[#1d4088] transition-all cursor-pointer shadow-md shadow-[#2650a8]/25 hover:scale-[1.02]"
            >
          ...
          <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:border-[#2650a8]/40 transition-all duration-300 flex flex-col justify-between group relative">
            <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-5 rounded-2xl text-xs sm:text-sm font-bold text-slate-800 bg-slate-50 hover:bg-[#2650a8] hover:text-white border border-slate-200 hover:border-[#2650a8] transition-all cursor-pointer shadow-xs group/btn hover:scale-[1.02]"
            >
