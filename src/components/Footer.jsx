      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-slate-200">
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <motion.a
                ...
                className="p-3 rounded-full bg-slate-50 border border-slate-200 text-slate-700 hover:text-white hover:bg-[#2650a8] hover:border-[#2650a8] transition-all shadow-xs"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-slate-50 border border-slate-200 text-slate-700 hover:text-white hover:bg-[#ec4899] hover:border-[#ec4899] transition-all shadow-xs"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-slate-50 border border-slate-200 text-slate-700 hover:text-white hover:bg-emerald-600 hover:border-emerald-600 transition-all shadow-xs"
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-2 text-xs text-slate-700 font-semibold pt-2">
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-emerald-600 transition-colors">
                <MessageCircle className="w-4 h-4 text-emerald-600" />
                <span>WhatsApp: +61 0433 035 338</span>
              </a>
              <a href={gayaLinkedinUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#2650a8] transition-colors">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-slate-500">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={scrollToTop}
            className="flex items-center gap-2 text-slate-600 hover:text-[#2650a8] transition-colors cursor-pointer px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200"
          >
