...
export default function Footer({ onOpenBooking }) {
  ...
  return (
    <footer className="bg-[#f8fafc] border-t border-slate-200 pt-16 pb-12 relative z-10 text-slate-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-slate-200">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a 
                ...
                className="p-2.5 rounded-full bg-white border border-slate-200 text-slate-600 hover:text-[#2650a8] hover:border-[#2650a8] transition-all shadow-xs"
                aria-label="LinkedIn"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2.5 rounded-full bg-white border border-slate-200 text-slate-600 hover:text-[#ec4899] hover:border-[#ec4899] transition-all shadow-xs"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2.5 rounded-full bg-white border border-slate-200 text-slate-600 hover:text-black hover:border-black transition-all shadow-xs"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2.5 rounded-full bg-white border border-slate-200 text-slate-600 hover:text-emerald-600 hover:border-emerald-500 transition-all shadow-xs"
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm font-semibold">
              ...
              <li><a href="#services" className="hover:text-[#2650a8] transition-colors">What We Do</a></li>
              <li><a href="#workflow" className="hover:text-[#2650a8] transition-colors">5-Step Process</a></li>
              <li><a href="#reviews" className="hover:text-[#2650a8] transition-colors">Reviews & Case Studies</a></li>
              <li><a href="#about" className="hover:text-[#2650a8] transition-colors">About Founder Gaya</a></li>
              <li><a href="#faq" className="hover:text-[#2650a8] transition-colors">Frequently Asked Questions</a></li>
            </ul>
          </div>

          {/* Contact & Booking */}
          <div className="md:col-span-4 space-y-4">
            <h4 className="font-heading font-bold text-sm text-[#000000] uppercase tracking-wider">Get In Touch</h4>
            <p className="text-xs text-slate-600 font-medium">
              Ready to automate your content and get real inbound client enquiries?
            </p>
            <button
              onClick={onOpenBooking}
              className="w-full py-3 px-5 rounded-full text-xs font-bold text-white bg-[#2650a8] hover:bg-[#1d4088] shadow-md transition-all cursor-pointer"
            >
              Book 1-on-1 Strategy Call
            </button>

            <div className="flex items-center gap-2 text-xs text-slate-700 font-semibold pt-2">
              <Mail className="w-4 h-4 text-[#2650a8]" />
